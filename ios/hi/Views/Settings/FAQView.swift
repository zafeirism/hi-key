...
private let faqItems: [FAQItem] = [
    ...
    FAQItem(
        ...
        answer: "You get free credits when you sign up to try hi-key. After that, you can earn more by inviting friends — you both get 5 free credits for every friend who joins."
    ),
    FAQItem(
