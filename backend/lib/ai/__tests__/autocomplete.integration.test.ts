...
describe.skipIf(!shouldRunTests)('Autocomplete tests', () => {
  ...
  it('should run in under 1.5 seconds', async () => {
    ...
    const prompts = [
      ...
      'There was a scientist guy mixing bottles that bubbling up way faster then should, and the whole lab shaking because some machine humming too loud, while notes scattered across desk with scribbles nobody can reads, and smoke coming out vents signaling something very not good happening soon, like comic book style',
